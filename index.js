...
// let kueCoklat = new KueCoklat(20)
// kueCoklat.bakingProgress(5)
// console.log('\n')

// let kueKacang = new KueKacang(25)
// kueKacang.bakingProgress(5)
// console.log('\n')

// let kueKeju = new KueKeju(30)
...
Kue.bakingCakeWithFlavor(20,'coklat').bakingProcess(5)
console.log('\n')
Kue.bakingCakeWithFlavor(25,'kacang').bakingProcess(5)
console.log('\n')
Kue.bakingCakeWithFlavor(30,'keju').bakingProcess(5)